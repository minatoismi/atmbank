...
class bank {
    public static void main (String args []){
        ...
        try{
            do{
                str = JOptionPane.showInputDialog(null, "Masukkan 4 Digit PIN Anda : ","ATM BRI SYARIAH - JOMBANG",0);
                ...
                if (pin==1234)
                    do{
                        ...
                        z=JOptionPane.showConfirmDialog(null,"Melanjutkan transaksi lain?","ATM BRI SYARIAH - JOMBANG", JOptionPane.YES_NO_OPTION, 3);
                        if (z==0)
                            break;
                        else
                        JOptionPane.showMessageDialog(null,"Terimakasih telah menggunakan ATM BRI SYARIAH - JOMBANG, ambil kartu ATM Anda.");
                        System.exit(0);
                        ...
                        z=JOptionPane.showConfirmDialog(null,
                                "Melanjutkan transaksi lain?","ATM BRI SYARIAH - JOMBANG", JOptionPane.YES_NO_OPTION, 3); //konfirmasi transaksi lain    if (z==0)    break;   else
                        if (z==0)   
                            break;  
                      ...
                      while (1==1);  else if (counter<3){   //jika pin salah  
                          a--;   
                 ...
                 { JOptionPane.showMessageDialog(null,
                         "Untuk bantuan nasabah,\nsilahkan menghubungi call center 555123 (Gratis)","Kartu ATM anda diblokir!",0);  System.exit(0);
                 } 
            }  
            while (1==1);  
